...
.list{ margin:  0 0 35px 0; font-size:14px;}
.list p{  margin: 10px 0; padding:0;}
.list h4{  margin: 0 0 5px 0; padding:0;}
.list .todoFun{  font-size:12px;text-decoration:underline;}
.list .todoFun:hover{ text-decoration:none;}
