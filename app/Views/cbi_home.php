...
<link rel='stylesheet' href='<?= base_url(); ?>/assets/fancybox/jquery.fancybox.min.css' type='text/css'/>
...
.tutorialBt{border: 5px solid #000;    margin: 20px auto 0 auto;     display: inline-block;}
.tutorialBt:hover{border: 5px solid #fd8e47;  }
	
.sbt_google{background:#fff url(<?= base_url().'/assets/images/btn_google2.png'; ?>) no-repeat  10px center;}	
...
.sbt_facebook{background:#fff url(<?= base_url().'/assets/images/btn_facebook.png'; ?>) no-repeat  10px center;}	
.sbt_apple{background:#fff url(<?= base_url().'/assets/images/btn_apple.png'; ?>) no-repeat  10px center;}	
...
.icon-facebook:before {     
	background-image: url('<?= base_url().'/assets/images/btn_facebook.png'; ?>');
...
.icon-microsoft:before {     
	background-image: url('<?= base_url().'/assets/images/btn_microsoft.png'; ?>');
    background-size: 15px 15px;
    display: inline-block;
    width: 15px; 
    height: 15px;
...
.icon-apple:before {     
	background-image: url('<?= base_url().'/assets/images/btn_apple.png'; ?>');
    background-size: 15px 15px;
    display: inline-block;
    width: 15px; 
    height: 15px;
...
<div id="site-logo" class="clr" itemscope itemtype="https://schema.org/Brand">
	...
	<div class="oceanwp-mobile-menu-icon clr mobile-right">
		...
		<a href="#" class="mobile-menu" aria-label="Mobile Menu">
			...
			<h2 class="elementor-heading-title elementor-size-default"><?= lang('cbi_lang.welcome', [],$userLg); ?><br /><?= lang('cbi_lang.cbi', [],$userLg); ?></h2>	
  ...
  <div id="signinTutorial">
  <hr style=" width: 100px; text-align: center; margin: 30px auto; border: #fff solid 1px; " />
	<?= lang('cbi_lang.signinTutorialTitle', [],$userLg); ?><br />
	<a data-fancybox class="tutorialBt tutorialBt<?= $userLg; ?>" href="<?= lang('cbi_lang.signinTutorialUrl', [],$userLg); ?>"><img src="<?= base_url(); ?>/assets/images/signinTutorialCover.png" alt="CBI Login instructions" /></a>
