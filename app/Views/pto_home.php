...
<div id="site-logo" class="clr" itemscope itemtype="https://schema.org/Brand">
	...
	<div class="oceanwp-mobile-menu-icon clr mobile-right">
		...
		<a href="#" class="mobile-menu" aria-label="Mobile Menu">
			...
			<h2 class="elementor-heading-title elementor-size-default">歡迎使用<br />Crosspoint PTO</h2>	
...
<?php elseif($isPtoSpUser): ?>
		
		<p>您是管理員, <a href="<?= base_url('pto/archive?v=pto'); ?>">點擊這裏</a>管理用戶的PTO請求</p>

<?php elseif($isPtoAdmin): ?>

		<p>您已登錄, <a href="<?= base_url('pto?v=pto'); ?>">點擊這裏</a>提交或管理您的PTO請求</p>
		<p>您是管理員, <a href="<?= base_url('pto/archive?v=pto'); ?>">點擊這裏</a>管理用戶的PTO請求</p>
