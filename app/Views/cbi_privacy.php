	...
	<div class="oceanwp-mobile-menu-icon clr mobile-right">
		...
		<a href="#" class="mobile-menu" aria-label="Mobile Menu">
			...
			<div class="elementor-column-wrap  elementor-element-populated">
				...
				<div class="elementor-widget-container" style="text-align: left;padding: 20px;">
...
sharing practices of Crosspoint Bible Institute (CBI).
</p>
<p>
	Unless otherwise stated, this Policy describes and governs the
information collection, use, and sharing practices of Crosspoint Bible
Institute (CBI) with respect to your use of our website (https://crosspointchurchsv.org/cbi/)
and the services we provide and/or host on our servers.
</p>
<p>
	Before you use or submit any information through or in connection with
the Services, please carefully review this Privacy Policy. By using any part of
the Services, you understand that your information will be collected, used, and
...
<p>
	Crosspoint Bible Institute (CBI) has designed this policy to be
consistent with the following principles:
</p>
<p>
	• Privacy policies should be
human readable and easy to find.
</p>
<p>
	• Data collection, storage, and
processing should be simplified as much as possible to enhance security, ensure
consistency, and make the practices easy for users to understand.
</p>
<p>
	• Data practices should meet
...
information directly to us; when we passively collect information from you,
such as from your browser or device; and from third parties.
</p>
<h1>
...
information from you in a variety of ways, such as when you: (a) create an
online account, (b) contact us or provide feedback, (c) subscribe to our
newsletter. This information may include but is not limited to your name, email
...
Internet server logs and online tracking technologies, like cookies and/or
tracking pixels. A web server log is a file where website activity is stored. A
cookie is a small text file that is placed on your computer when you visit a
website, that enables us to: (a) recognize your computer; (b) store your
preferences and settings; (c) understand the web pages of the Services you have
visited and the referral sites that have led you to our Services; (d) enhance
your user experience by delivering content
specific to your inferred interests; (e) perform searches and analytics;
and (f) assist with security administrative functions. Tracking pixels (sometimes
...
number of unique viewers of them.
</p>
...
the Services, and for technical and customer support.
</p>
<p>
	• Send you information about
your interaction or transactions with us, account alerts, or other
communications, such as newsletters to which you have subscribed.
</p>
<p>
	• Process and respond to your
inquiries or to request your feedback.
</p>


<h1>
	Your Choices and Data
Subject Rights
</h1>
<p>
	You have various rights with respect to the collection and use of your
information through the Services. Those
...
the “unsubscribe” link at the bottom of each newsletter or by emailing [EMAIL
...
the purposes set forth in this Privacy Policy or as long as we are legally
required or permitted to do so. Information may persist in copies made for
...
Facebook “like” button and Twitter “follow” button), and other services. If you
choose to use these sites or features, you may disclose your information not
just to those third-parties, but also to their users and the public more
generally depending on how their services function. Creative Commons is not
responsible for the content or privacy practices of such third-party websites
or services. The collection, use and disclosure of your information will be
subject to the privacy policies of the third-party websites or services, and
not this Privacy Policy. We encourage you to read the privacy statements of
...
practices, you can contact us at: training@crosspointchurchsv.org.
</p>
