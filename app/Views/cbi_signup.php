...
<style>
.step2 #mInfoDiv{display:none;}
.step1 #btSPrev{display:none;}
.bts2{ margin-top: 15px;}
.elementor-557 .elementor-element.elementor-element-294e5577 {
    transition: background 0.3s, border 0.3s, border-radius 0.3s, box-shadow 0.3s;
    padding: 50px 0px 50px 0px;
    z-index: 1;
}
#btSPrev:hover{background-color: #33CCFF;}

#loginMsg{color:red;font-size:12px;}
...
<div id="site-logo" class="clr" itemscope itemtype="https://schema.org/Brand">
	...
	<div class="oceanwp-mobile-menu-icon clr mobile-right">
		...
		<a href="#" class="mobile-menu" aria-label="Mobile Menu">
			...
			<h2 class="elementor-heading-title elementor-size-default">Crosspoint Bible Institute (CBI)</h2>	
			...
			<div class="elementor-column-wrap  elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<h1 class="elementor-heading-title elementor-size-default">Sign up</h1>		<p style=" margin-top: 20px; ">Already have an account? <a href="<?php echo base_url().'/?logout=1'; ?>">Sign in</a></p><p style=" margin-top: 20px; ">If you have any questions or encounter any problem, please email: <a href="mailto:training@crosspointchurchsv.org">training@crosspointchurchsv.org</a></p>
</div>
				</div>
	...
	<div id="s-confirmed">	
		<p>Successfully verified! Congratulations! You have successfully verified the email address. <a href="<?= base_url(); ?>">Sign in [<span id="timer">?</span>]</a></p>	
	</div>	
...
<?php elseif(isset($confirmed)&&!$confirmed): ?>

	<div id="s-confirmed">
		<p>Email address confirmation link is invalid! Please try <a href="<?= (base_url().'/signup')?>">signing up</a> again.</p>
	</div>	

<?php elseif(isset($_GET["confirmation"])): ?>

	<p>We have sent an email with a confirmation link to your email address [<?= $_GET["confirmation"]; ?>]. In order to complete the sign-up process, please click the confirmation link. <i>If you do not receive a confirmation email, please check your spam folder.</i> Also, please verify that you entered a valid email address in our sign-up form. </p>	
...
<?php if(isset($_SESSION["dsfService"])): //<p>Your account is nearly ready. </p> ?>
...
<form action="<?= base_url().'/signup?submit=1'; ?>" method="post"class="step1"  id="SignupForm" onkeydown="if(event.keyCode==13){return false;}">
	...
	<div id="mInfoDiv">
		<p>Your Email: <input <?= (isset($_SESSION['dsfEmail'])?'value="'.$_SESSION['dsfEmail'].'"':''); ?> class="required email" title="Email"  type="text" name="mEmail" id="mEmail" /></p>
	
		<p>First Name(required): <input class="required" title="First Name" type="text" <?= (isset($_SESSION['dsfFname'])?'value="'.$_SESSION['dsfFname'].'"':''); ?> name="fn" id="fn" /></p>
		
		<p>Middle Name(Optional): <input title="Middle Name" type="text" <?= (isset($_SESSION['dsfMname'])?'value="'.$_SESSION['dsfMname'].'"':''); ?> name="mn" id="mn" /></p>
		
		<p>Last Name(required): <input class="required" title="Last Name" type="text" <?= (isset($_SESSION['dsfLname'])?'value="'.$_SESSION['dsfLname'].'"':''); ?> name="ln" id="ln" /></p>
		...
		<p>Site 聚會地點 (*):	
			<select name="site" title="Site 聚會地點"  id="site">
			<option value="">---</option>
			<?php
	...
	<input value="« Prev" type="button" id="btSPrev">
	
	<input type="hidden" name="action"  value="signup" />
	
	
	<input type="submit"  id="btSignup" value="Continue »" />
...
<div id="footer-widgets" class="oceanwp-row clr">
	...
	<div class="footer-widgets-inner container">
					...
					<p style=" margin-top: 20px; ">If you have any questions or encounter any problem, please email: <a href="mailto:training@crosspointchurchsv.org">training@crosspointchurchsv.org</a></p>
...
$("#SignupForm").submit(function(event){
	...
	var error='';
	$('#loginMsg').html('Loading...');
	
	error = validater(document.getElementById('SignupForm'));
			...
			ajaxer = $.ajax({
				...
				success:function(data){ 
						...
						if(validateEmail(data)){
							...
							location.replace(baseUrl+'/signup?confirmation='+data);
							...
							$('.step1').addClass('step2').removeClass('step1');
							$('#returnDiv').html(data);
						}
