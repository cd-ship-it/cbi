...
<div class="tab-content" id="nav-tabContent">
	<div class="tab-pane fade show active p-3" id="nav-users" role="tabpanel" aria-labelledby="nav-users-tab">
		<form id="searchBox">
							...
							<p>Name: <input class="form-control" title="Name" type="text" value="<?= (isset($inputName)?$inputName:''); ?>"  name="query" id="query" /></p>
							
							<p class="my-3 ageSlider"><span class="mr-3">Age:</span> <input id="ageSlider" name="ageSlider" type="text" class="span2 form-control px-5" value="" data-slider-min="0" data-slider-max="99" data-slider-step="1" data-slider-value="[<?= ((isset($inputAge1)&&$inputAge1?$inputAge1:0)); ?>,<?= ((isset($inputAge2)&&$inputAge2?$inputAge2:99)); ?>]"/></p>
...
<script type='text/javascript' src='<?= base_url(); ?>/assets/theme-sb-admin-2/vendor/bootstrap-slider/bootstrap-slider.min.js'></script>
<link rel='stylesheet' href='<?= base_url(); ?>/assets/theme-sb-admin-2/vendor/bootstrap-slider/bootstrap-slider.css' type='text/css' />
