...
<?php
		...
		if(!$admins){
			...
			foreach($admins as $item){ 
				...
				echo '<p><a href="'.base_url('xAdmin/baptist/'.$item['bid']).'">'.$item['name'].'</a> | Permission: '.$optionsHtml.' | <a href="javascript:void(0);" class="removeAdmin" data-uid="'.$item['id'].'">- remove</a> <span></span></p>';
			}
		}
